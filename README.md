...
Setup
Clone the repository: git clone https://github.com/your-repo/currency-conversion.git
css Copy

Navigate to the project directory: cd currency-conversion
markdown Copy

Add your API key to application.properties: exchange.api.key=YOUR_API_KEY
markdown Copy
